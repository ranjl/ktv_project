...
export default class ClenaPs extends Component {
    //构造器
    constructor(props) {
        super(props)
        //初始化视频播放
    ...
    skip(e){
        if(e=='清除'){
            ...
            this.state.values.pop() // 删除替代密码的最后一位
            this.state.value.pop() // 删除真实密码的最后一位
            this.setState({
            ...
            this.state.values.push({txt:'*',id:this.state.num}) // 添加替代密码
